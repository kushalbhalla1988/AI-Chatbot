...
import json
import random
intents = json.loads(open('c:\\Users\\kushal bhalla\\Downloads\\\python-project-chatbot-codes\\Intent folder\\intent_Final (1).1.json', encoding='utf-8').read())
...
base = Tk()
base.title("Claim center AIRYN Bot")
